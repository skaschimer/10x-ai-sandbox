...
# ##############################################################################
# # We use the same base image as the final image, but here we install
# # all system packages and Python dependencies needed for building.
...
FROM jimmoffetgsa/gsai:cfs4linux-builder AS builder

# ##############################################################################
# ###               3) FINAL RUNTIME IMAGE                                   ###
# ##############################################################################
FROM cloudfoundry/cflinuxfs4:1.232.0 AS final
