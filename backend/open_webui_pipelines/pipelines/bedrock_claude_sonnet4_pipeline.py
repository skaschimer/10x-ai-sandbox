...
class Pipeline:
    class Valves(BaseModel):
        ...
        BEDROCK_CLAUDE_SONNET_4_ARN: Optional[str]
    ...
    def __init__(self):
        ...
        self.valves = self.Valves(
            **{
                ...
                "BEDROCK_CLAUDE_SONNET_4_ARN": os.getenv("BEDROCK_CLAUDE_SONNET_4_ARN", None),
            }
        )
    ...
    def pipe(
        ...
        model_id = self.valves.BEDROCK_CLAUDE_SONNET_4_ARN
