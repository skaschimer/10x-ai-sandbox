...
from open_webui.utils.logs import setup_logging, structlog_context_middleware_factory
...
app.state.config.RAG_WEB_SEARCH_EXTRA_QUERY_PARAMS = (
    config.RAG_WEB_SEARCH_EXTRA_QUERY_PARAMS
)
